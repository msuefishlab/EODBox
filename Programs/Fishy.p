...
// The original program was writen by Derek Molloy to align with the content of the book 
// Exploring BeagleBone. See exploringbeaglebone.com/chapter13/
// Modified By Bailey Winter June 2015 for the Electric Fish Project
...
START:
	...
	LBBO    r10, r1, 4, 4  //load starting address of memory to r10 
	ADD 		r8, r10 , 4		// load the Linux address that is passed into r8 -- to store sample values
...
STORE_DATA:                      // store the sample value in memory
	...
	SUB 		r12, r8, r10  //store difference between r8 and r10
	SBBO 	r12, r10, 0, 4 //store head address to first position in shared memory
	QBEQ	REWIND, r9, 0       // have taken the full set of samples
...
REWIND:			//Loop back to enter more data
	MOV r9, r11		//load  the address at r11 to r9
	ADD r8 , r10, 4	//load the Linux address that is passed into r8 -- to store sample values
	QBA	SAMPLE_WAIT_LOW
